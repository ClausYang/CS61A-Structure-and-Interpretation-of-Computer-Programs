...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for i in range(num_rolls):
        ...
        if tmp==1: flag=True
        total_sum += tmp
    return total_sum if flag==False else 1
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    return abs(player_score%10-opponent_score//10%10)*3 if player_score%10-opponent_score//10%10!=0 else 1
    # END PROBLEM 2
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    # return num_rolls  # Remove this line once implemented.
    # return 0 if sus_update(num_rolls,score,opponent_score)-score>=threshold else num_rolls
...
def final_strategy(score, opponent_score):
    ...
    1. If you know the goal score (by default it is 100), there's no benefit to scoring more than the goal. Check whether you can win by rolling 0, 1 or 2 dice.
    If you are in the lead, you might decide to take fewer risks.
    2. Instead of using a threshold, roll 0 whenever it would give you more points on average than rolling 6.
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    # return 6  # Remove this line once implemented.
    threshold = 100-score
    return sus_strategy(score, opponent_score, threshold=threshold)
    # END PROBLEM 12
